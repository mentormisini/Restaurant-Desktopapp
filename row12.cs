...
namespace Stresta
{
    class row12
    {
        public void rowg12(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3, TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {


                textBox3.Text = dataGridView1.Rows[12].Cells[1].Value.ToString();
                textBox5.Text = dataGridView1.Rows[12].Cells[2].Value.ToString();
