...
namespace Stresta
{
    class row11
    {
        public void rowg11(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3, TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {


                textBox3.Text = dataGridView1.Rows[11].Cells[1].Value.ToString();
                textBox5.Text = dataGridView1.Rows[11].Cells[2].Value.ToString();
