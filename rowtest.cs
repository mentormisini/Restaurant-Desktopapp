...
namespace Stresta
{
    class rowtest
    {
        public void rowtestg(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3, TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView.Rows)
                {
                    ...
                    row.Cells[dataGridView.Columns["lloji"].Index].Value = textBox2.Text;
                }
