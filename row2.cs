...
namespace Stresta
{
    class row2
    {
        public void rowg2(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3, TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {
                ...
                textBox5.Text = dataGridView1.Rows[2].Cells[2].Value.ToString();
