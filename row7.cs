...
namespace Stresta
{
    class row7
    {
        public void rowg7(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3, TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {


                textBox3.Text = dataGridView1.Rows[7].Cells[1].Value.ToString();
