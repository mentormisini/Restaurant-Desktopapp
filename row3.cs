...
namespace Stresta
{
    class row3
    {
        public void rowg3(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3, TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {
                ...
                textBox5.Text = dataGridView1.Rows[3].Cells[2].Value.ToString();
