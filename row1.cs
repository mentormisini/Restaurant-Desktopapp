...
namespace Stresta
{
    class row1
    {
        public void rowg1(DataGridView dataGridView1, TextBox textBox5, TextBox textBox3,TextBox textBox2, DataGridView dataGridView, Label label2)
        {
            try
            {


                textBox3.Text = dataGridView1.Rows[1].Cells[1].Value.ToString();
